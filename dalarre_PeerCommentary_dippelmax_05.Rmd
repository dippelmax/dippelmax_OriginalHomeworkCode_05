...
for (i in 1:1000) {
  ...
  ## Diego: I didn't know you could do that, it makes everything so much easier!
  ...
  ## Diego: How does this work? Why are you putting the variable you are defining as part of its definition?
}
...
## Diego: I don't think so, the sd() function already calculates the standard deviation of a sample
```
...
## Diego: Good job! Everything is very clear and the code is very concise.
```
